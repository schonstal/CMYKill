...
{
  public static var RADIUS:Array<Int> = [24,36,30];
  ...
  private function drawCircles():Void {
    ...
    drawCircle(-1, -1, big ? RADIUS[colorIndex] : RADIUS[colorIndex] - 1,
                           colors[colorIndex][1],
                           {color: 0});
    drawCircle(-1, -1, big ? RADIUS[colorIndex] - 4 : RADIUS[colorIndex] - 5,
                           colors[colorIndex][0],
                           {color: 0});
  }
}
